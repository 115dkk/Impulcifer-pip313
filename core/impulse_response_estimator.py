...
def create_cli():
    ...
    arg_parser.add_argument('--tracks', type=str, required=False, default='mono',
                            help='WAV file track configuration. Supported values are "mono", "stereo", "5.1" and '
                                 '"7.1". This should be set according to sound card. "stereo" accepts any one or two '
                                 'speakers, mapped positionally to the left/right channels. Supported speaker names '
                                 'for "7.1" are "FL", "FR", "FC", "BL", "BR", "SL" and "SR". Supported speaker names '
                                 'for "5.1" are "FL", "FR", "FC", "SL", "SR", "BL" and "BR". "mono" will force '
                                 'speakers to "FL".')
