...
dir_path = r"E:\Impulcifer\_verification\lion_trace"
...
headphone_compensation(estimator, dir_path)
...
synthesize_virtual_bass(hrir, xo_hz=250, head_ms=1, invert_polarity=False)
